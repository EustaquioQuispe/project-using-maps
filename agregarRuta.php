...
<body>
  ...
  <div class="datos-ruta" style="width:48%; float:left;">
      <div id="tabs" role="tabpanel">
            <form name="frmImage" enctype="multipart/form-data" action="" method="post" class="frmImageUpload" >
                ...
                <table>
                    <tr>
                        <td><button type="submit" name="btn-save" class="btnSubmit btn btn-alert">Guardar</button></td>
                    </tr>
                    <tr>
                        <td><input type="button" onclick="clearPolyLine()" value="Eliminar markers" class="btn btn-primary"/> Eliminar todos los markers</td>
                    </tr>
                </table>
            </form>
